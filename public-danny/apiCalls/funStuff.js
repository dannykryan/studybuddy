...
async function populate(){
    //get data from API
    let response = await fetch('http://localhost:7000/funstuff');
...
form.addEventListener("submit", async (e) => {
    ...
    let resource = {title: e.target[0].value, description: e.target[3].value, link: e.target[1].value, imglink: e.target[2].value, category: 'fun stuff'}
